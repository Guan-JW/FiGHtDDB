...
func (pt *PlanTree) Print() {
	...
	for _, node := range pt.Nodes {
		...
		// fmt.Println(node)
		fmt.Println("Id=", node.Nodeid, ";Locate", node.Locate, "; Rel_cols:", node.Rel_cols, "; ExecStmtCols:", node.ExecStmtCols, "; ExecStmtWhere:", node.ExecStmtWhere, "; TmpTable:", node.TmpTable, "; Left:", node.Left, ";Right:", node.Right)
	}
	return
}
